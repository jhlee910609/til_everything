...
2명의 주니어 개발자와 함께 유료 기능 및 제약 기능 개발과 멘토링을 수행하였다.
...
[theming 방식 변경으로 약 6배 성능 최적화]: ../../front-end/css/css%20global%20variables로%20theming%20하기.md
[build 성능 최적화]: ../../../docs/me/sass-거둬내고-css-in-js-사용하기.md
