# 롯데e커머스 (롯데ON)
> **Frontend Developer** | 2022.03 ~ 현재 (3년 10개월)
>
...
### 2. Legacy Improvement & DX (Developer Experience)
*상시 진행*
...
*   **Internal Tool**: 각종 전시 관련 지표 데이터를 시각화하여 PO, 마케터에게 제공하는 전시 관리 대시보드(Bigbro) 개발.

**결가 (Result):**
*   **Efficiency**: 사내 **베스트 프랙티스 선정** 및 전시 기획/개발 업뮤 효율 비약적 증대.
...
*   **Network Optimization**: **React-Query In-Memory Caching** 및 `AbortController`를 도입하여 비동기 검색 요청의 Race Condition 해결 및 리소스 낭비 방지.
